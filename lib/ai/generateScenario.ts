...
const TOPICS_BY_WEEK: Record<number, string[]> = {
  ...
  6: [
    'all Scrum roles, artifacts, events, story points, planning poker, velocity',
  ...
  7: [
    'all prior topics through Scrum, estimation, XP, Lean, and Kanban',
  ...
  11: [
    'all prior topics through architectural styles and patterns',
  ...
  12: [
    ...
    'Git workflows: branching strategies, merge vs rebase, release tagging',
    'configuration management: tracking and controlling changes',
    'dependency management: semantic versioning, vulnerability handling, reproducible builds',
  ],
  13: [
    'all prior topics through configuration and dependency management',
    'CI: automated build and test on every commit',
    'CD: continuous delivery vs continuous deployment',
    'pipeline stages: build, test, quality gates, deploy',
    'DevOps culture: shared ownership of shipping and operating software',
  ],
}
...
const JARGON_CONSTRAINTS: Record<number, string> = {
  ...
  5: 'Students now know Scrum roles, events, artifacts, story points, and planning poker. You MAY use sprint, backlog, Product Owner, Scrum Master, velocity, etc.',
  6: 'Students know full Scrum plus XP, Lean, and Kanban. You MAY reference pair programming, TDD, WIP limits, and methodology trade-offs.',
  7: 'Students know Scrum, estimation, and alternative methods. You MAY introduce requirements engineering vocabulary: elicitation, use case, acceptance criteria.',
  ...
  9: 'Students now know SOLID principles, code smells, and refactoring. Scenarios may involve design debates and refactoring decisions.',
  10: 'Students know software design plus architectural styles and GoF patterns. Scenarios may involve architecture trade-off discussions.',
  11: 'Students know code review practices and static analysis. Scenarios may involve review feedback, tooling, and process improvement.',
  12: 'Students know Git workflows and dependency management. Scenarios may involve branching conflicts, versioning, or a dependency vulnerability.',
  13: 'Students know CI/CD and DevOps practices. Scenarios may involve pipeline design, automation resistance, or deployment strategy.',
}
