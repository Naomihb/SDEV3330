...
-- NOTE: do NOT use a subquery on profiles inside a profiles policy — causes infinite recursion
...
begin
  ...
  insert into public.courses (id, code, name, semester, instructor_id, join_code)
  values (uuid_generate_v4(), 'CS 3330', 'Software Development Processes and Methodologies', 'Fall 2026', v_instructor_id, 'cs3330-f26')
  ...
  (v_course_id,2, 'SDLC Fundamentals',                                  'Identify which SDLC phase your project is entering and justify the choice to your team.',                     '2026-09-02',false,ARRAY['Course Introduction & Team Setup']),
  (v_course_id,3, 'SDLC Models: Comparison & Use Cases',                'Your team debates which SDLC model fits the project. How do you facilitate the decision?',                   '2026-09-09',false,ARRAY['Course Introduction & Team Setup','SDLC Fundamentals']),
  (v_course_id,4, 'Agile Methodology',                                  'Draft your team working agreement. One teammate wants to skip ceremonies and just ship.',                     '2026-09-16',false,ARRAY['SDLC Fundamentals','SDLC Models: Comparison & Use Cases']),
  (v_course_id,5, 'Scrum Framework',                                    'Run sprint planning. Handle your first conflict around story point estimates.',                               '2026-09-23',false,ARRAY['SDLC Models: Comparison & Use Cases','Agile Methodology']),
  (v_course_id,6, 'Estimation & Planning',                              'Your team cannot agree on story point estimates during planning poker. Velocity from last sprint was low.',   '2026-09-30',false,ARRAY['Agile Methodology','Scrum Framework']),
  (v_course_id,7, 'Requirements Engineering',                           'Elicit requirements from a vague stakeholder who keeps changing scope.',                                      '2026-10-07',false,ARRAY['Scrum Framework','Estimation & Planning']),
